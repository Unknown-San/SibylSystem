...
async def status(event):
    msg = await event.reply("Connecting to SPK System.")
    time.sleep(1)
    await msg.edit("Initialising, wait plox ▫▫▫▫▫▫")
    time.sleep(1)
    await msg.edit("Initialising, wait plox ▪▫️▫▫▫▫")
    time.sleep(1)
    await msg.edit("Initialising, wait plox ▪▪▫▫▫▫")
    time.sleep(1)
    await msg.edit("Initialising, wait plox ▪▪▪▫️▫▫")
    ...
    await msg.edit("Initialising, wait plox ▪▪▪▪▫️▫")
    time.sleep(1)
    await msg.edit("Initialising, almost done ▪▪▪▪▪▫")
    time.sleep(1)
